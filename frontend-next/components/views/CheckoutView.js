    ...
    return (
      <div className="max-w-2xl mx-auto px-6 md:px-10 py-20 text-center fade-in">
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          <button data-testid="ck-confirmed-view-orders" onClick={() => router.push("/orders")} className="btn-primary">View My Orders</button>
          <button data-testid="ck-confirmed-continue-shopping" onClick={() => router.push("/shop")} className="btn-ghost">Continue Shopping</button>
        </div>
      </div>
    );
  }
